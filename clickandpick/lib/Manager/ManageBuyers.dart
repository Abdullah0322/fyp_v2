...
import '../BuyerDashboard/title_text.dart';

class ManageBuyers extends StatefulWidget {
  @override
  _ManageBuyersState createState() => _ManageBuyersState();
}

class _ManageBuyersState extends State<ManageBuyers> {
  DocumentSnapshot a;
